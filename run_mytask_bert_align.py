...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    cached_features_file = os.path.join(args.data_dir, 'cached_{}_bert_{}_{}_mytask_sfu_merge'.format(
...
def main():
    ...
    parser.add_argument("--output_dir", default="output_bert_mytask_sfu_merge", type=str,
    ...
    config = config_class.from_pretrained("./pretrained/bertbase/config.json",num_labels=num_labels,finetuning_task=args.task_name)
    tokenizer = tokenizer_class.from_pretrained("./pretrained/bertbase/")
    model = model_class.from_pretrained("./pretrained/bertbase/bert-base-uncased-pytorch_model.bin", from_tf=False,
                                        config=config)
