...
os.system("python -m torch.utils.bottleneck ./run_mytask_roberta.py")
os.system("python -m torch.utils.bottleneck ./run_mytask_roberta_align.py")
os.system("python -m torch.utils.bottleneck ./run_mytask_distil.py")
