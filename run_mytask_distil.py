...
def train(args, train_dataset, model, tokenizer):
    """ Train the model """
    tb_writer = SummaryWriter("./runs2/distilbert/")
...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    cached_features_file = os.path.join(args.data_dir, 'cached_{}_disbert_{}_{}_last'.format(
...
def main():
    ...
    parser.add_argument("--output_dir", default="distilbert", type=str,
    ...
    config = config_class.from_pretrained("./pretrained/distilbert/config.json", num_labels=num_labels,
