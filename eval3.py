...
config = config_class.from_pretrained("./output_disbert_merge/config.json")
tokenizer = tokenizer_class.from_pretrained("./pretrained/distilbert/")
model = model_class.from_pretrained("./output_disbert_merge/pytorch_model.bin", from_tf=False,
                                    config=config)
...
with open("results_distilbert.json","w",encoding="utf8") as fout:
