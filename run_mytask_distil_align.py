...
def load_and_cache_examples(args, task, tokenizer, evaluate=False):
    ...
    cached_features_file = os.path.join(args.data_dir, 'cached_{}_distilbert_align_{}_{}_mytask_sfu_merge'.format(
...
def main():
    ...
    parser.add_argument("--output_dir", default="output_distilbert_align_merge", type=str,
