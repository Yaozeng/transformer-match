...
def train(args, train_dataset, model, tokenizer):
    ...
    optimizer_grouped_parameters = [
        ...
        {'params': [p for n, p in model.named_parameters() if 'classifier' in n or 'linear_transform' in n], 'lr': 1e-3}
    ]
...
def main():
    ...
    parser.add_argument("--output_dir", default="output_qnli_gate2", type=str,
